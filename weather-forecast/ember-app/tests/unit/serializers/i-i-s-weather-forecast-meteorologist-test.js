...
moduleForModel('i-i-s-weather-forecast-meteorologist', 'Unit | Serializer | i-i-s-weather-forecast-meteorologist', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-weather-forecast-meteorologist',
    'transform:file',
    'transform:decimal',
    'transform:guid',
