...
moduleForModel('i-i-s-weather-forecast-possible-cataclysm', 'Unit | Serializer | i-i-s-weather-forecast-possible-cataclysm', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-weather-forecast-possible-cataclysm',
    'transform:file',
    'transform:decimal',
    'transform:guid',
