...
moduleForModel('i-i-s-weather-forecast-precipitation', 'Unit | Serializer | i-i-s-weather-forecast-precipitation', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-weather-forecast-precipitation',
    'transform:file',
    'transform:decimal',
    'transform:guid',
